...
public class Tutores {
    ...
    public Tutores(int ci,String estado, String primNom,String segNom, String primApe,String segApe,String mailPpal,String mailSec, Date fechaNac,Date fechaReg, Image foto, char sexo, String telefono, Date fechaIniTuto, int auto_increment){
        this.ci = ci;
        ...
        this.foto = foto;
        this.fechaIniTuto = fechaIniTuto;
    ...
    public Date getFechaIniTuto() {
        return fechaIniTuto;
    }

    public void setFechaIniTuto(Date fechaIniTuto) {
        this.fechaIniTuto = fechaIniTuto;
    }
