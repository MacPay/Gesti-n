...
public class Funcionarios {
    ...
    public Funcionarios(int ci,String estado, String primNom, String segNom, String primApe, String segApe, String mailPpal, String mailSec, Date fechaNac, Date fechaReg, Image foto, char sexo, String telefono, Date fechaIng, int numReg, double salario, int auto_increment){
        this.ci = ci;
